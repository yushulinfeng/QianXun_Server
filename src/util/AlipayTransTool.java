...
public class AlipayTransTool {
	 ...
	 *            生成的文件路径
	 */
	public static boolean transToExcel(List<TradeRecord> array, String batchNumber, String payTime,
		...
		try {
			...
			WritableWorkbook book = Workbook.createWorkbook(new File(excel_file_path), wb);
		...
		try {
			...
			for (int i = 0; i < count; i++) {
				...
				try {
					...
					if (end == 9)
						an_trade.setFinalStatus(("处理成功".equals(row[8])) ? 1 : 2);// 获取批量付款结果的列表
					else
	...
	public static void main(String[] args) {
		...
		System.out.println(transToExcel(array, "201604240001", "20160424 12:23:34", "d:\\456.xls"));
	}
